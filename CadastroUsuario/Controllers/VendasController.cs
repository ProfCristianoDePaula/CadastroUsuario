...
namespace CadastroUsuario.Controllers
{
    ...
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaId,NomeCliente,DataVenda")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("VendaId,NomeCliente,DataVenda")] Venda venda)
        {
            if (id != venda.VendaId)
            {
                return NotFound();
